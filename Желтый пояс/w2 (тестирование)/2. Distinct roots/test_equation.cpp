...
void TestNoRootD() {
    AssertEqual(GetDistinctRealRootCount(1, 1, 4), 0);
}
void TestOneRootD2() {
...
int main() {
  ...
  runner.RunTest(TestOneRootD,"TestOneRootD");
  runner.RunTest(TestNoRootD, "TestNoRootD");
  runner.RunTest(TestOneRootD2, "TestOneRootD2");
  runner.RunTest(TestTwoRootD, "TestTwoRootD");
  return 0;
}
